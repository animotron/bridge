...
(function($){
    ...
    var evalSocket = $.socket("eval").onMessage(function(){
        modified = false;
        var W = self.width();
    ...
    commands.addCommand({
        ...
        exec: function(env, args, request) {
            saveSocket.send(editor.getSession().getValue());
        }
    });
    ...
    commands.addCommand({
        ...
        exec: function(env, args, request) {
            evalSocket.send(editor.getSession().getValue());
        }
    });
