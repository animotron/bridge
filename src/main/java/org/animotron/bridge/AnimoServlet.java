...
public class AnimoServlet extends HttpServlet {
	...
	private void writeResponse(Relationship r, HttpServletResponse res) throws IOException, ENotFound {
    ...
    private static class AnimoNotFound extends AbstractExpression {
        ...
        public AnimoNotFound(HttpServletRequest req) throws EBuilderTerminated {
    ...
    private static class WebSerializer {
        ...
        public static void serialize(final Relationship r, HttpServletResponse res) throws IOException, ENotFound {
            ...
            try {
                ...
                if (content != null) {
                    ...
                    if (isNotFound[0]) {
                         ...
                         throw new ENotFound("Resource not found");
        ...
        private static Relationship get(Relationship r, String have) throws EBuilderTerminated, IOException, InterruptedException {
