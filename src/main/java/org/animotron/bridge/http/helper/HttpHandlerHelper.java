...
public class HttpHandlerHelper {
    ...
    public static void sendFile(final ChannelHandlerContext ctx, final FullHttpRequest request, final File file, String mime, String cache) throws Throwable {
    ...
    public static void serialize(ChannelHandlerContext ctx, Expression e, FullHttpRequest request, FullHttpResponse response, String uuid) throws Throwable {
